  ...
  return (
    <section className="py-24 md:py-32 bg-background text-foreground px-4 md:px-8 border-b border-border relative overflow-hidden">
      ...
      <div className="mt-24 flex justify-center">
        <Link href="/strategy" className="group relative px-8 py-4 bg-primary text-primary-foreground font-mono font-bold text-sm overflow-hidden rounded-full shadow-lg hover:shadow-primary/25 transition-all duration-300 hover:-translate-y-1 inline-flex items-center gap-2">
